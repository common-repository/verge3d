...
= 4.7.0 =
* Support REST API for form submissions.
* Support REST API for order submissions via FormData.
* Preserve MIME type for uploaded files.
* Improve error reporting for admin interface and REST API.
* Security fixes.

= 4.6.0 =
* Support chunked uploads. Allows publishing huge assets with no tweaking of PHP settings.
